      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: DECATHLON.<br>
            Kristu Jayanti College,560077
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:080123456">8884-443-355</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@decathlon.com" class="email__addr">support@decathlon.com</a>
            </div>
          </div>
